...
class ObjectModelModuleGenerator():
    ...
    def generate_root_class(self):
        class_generator = ClassGenerator(self.root_schema, self.root_class_name, self.code_gen_hints, self.output_directory)
    ...
    def generate_definition_class(self, definition_key, definition_schema):
        ...
        class_generator = ClassGenerator(definition_schema, class_name, self.code_gen_hints, self.output_directory)
        class_generator.generate()
